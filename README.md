...
![Version](https://img.shields.io/badge/Version-5.5.0-blue.svg) ![Framework](https://img.shields.io/badge/Framework-AstrBot-green.svg)
...
| 模块 | 指令示例 | 功能说明 |
| :--- | :--- | :--- |
| **阅读系统** | `/来篇阅读` | 随机抽取一篇**从未做过**的阅读真题，生成HTML文件。 |
| | `/阅读答案 ABCD` | 提交阅读选项，系统自动批改出分。 |
| | `/查答案` | 放弃做题，直接查看当前阅读的正确答案并标记已做。 |
| **听力系统** | `/来个听力` | 随机抽取一套**从未做过**的听力真题，生成HTML文件（音频已嵌入）。 |
